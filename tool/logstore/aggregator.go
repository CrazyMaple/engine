...
func (cl *ContextLogger) With(kvs ...interface{}) log.Logger {
	c := cl.copy()
...
func (cl *ContextLogger) Debug(msg string, kvs ...interface{}) {
	cl.emit(log.LevelDebug, msg, kvs)
}

// Info 信息日志
func (cl *ContextLogger) Info(msg string, kvs ...interface{}) {
	cl.emit(log.LevelInfo, msg, kvs)
}

// Warn 警告日志
func (cl *ContextLogger) Warn(msg string, kvs ...interface{}) {
	cl.emit(log.LevelWarn, msg, kvs)
}

// Error 错误日志
func (cl *ContextLogger) Error(msg string, kvs ...interface{}) {
	cl.emit(log.LevelError, msg, kvs)
}

func (cl *ContextLogger) emit(level log.Level, msg string, kvs []interface{}) {
